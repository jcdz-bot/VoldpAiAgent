...
const LI_PATHS = {
  ...
  // Tool cards (MCP / live tools)
  'file-diff':       '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M12 12v6"/><path d="M9 15h6"/>',
  'search-code':     '<path d="m13 13 3-3"/><path d="m14 14 2-2"/><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',
  'folder-open':     '<path d="m6 14 1.5-2.5A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.79 2.89l-2 4A2 2 0 0 1 17.97 18H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v2"/>',
  'code-2':          '<path d="m18 16 4-4-4-4"/><path d="m6 8-4 4 4 4"/><path d="m14.5 4-5 16"/>',
  'webhook':         '<path d="M18 16.98h-5.99c-1.1 0-1.95.94-2.48 1.9A4 4 0 0 1 2 17c.01-.7.2-1.4.57-2"/><path d="m6 17 3.13-5.78c.53-.97.1-2.18-.5-3.1a4 4 0 1 1 6.89-4.06"/><path d="m12 6 3.13 5.73C15.66 12.7 16.9 13 18 13a4 4 0 0 1 0 8h-1"/>',
  'help-circle':     '<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/>',
  'database':        '<ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5V19A9 3 0 0 0 21 19V5"/><path d="M3 12A9 3 0 0 0 21 12"/>',
  'brain-circuit':   '<path d="M12 5a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V8a3 3 0 0 0-3-3Z"/><path d="M12 5V2"/><path d="M9 8H6"/><path d="M15 8h3"/><path d="M9 16H6"/><path d="M15 16h3"/>',
  'list-start':      '<path d="M16 12H3"/><path d="M16 18H3"/><path d="M16 6H3"/><path d="M21 12l-4 4"/><path d="M21 12l-4-4"/>',
...
function li(name, size = 16) {
  let p = LI_PATHS[name];
  if (!p) { console.warn('li(): unknown icon', name); p = LI_PATHS['square']; }
